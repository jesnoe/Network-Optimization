...
for (alpha in seq(1, 0, by=-0.1)) {
  ...
  opt_sol %>% write.csv(paste0("Cocaine Network Optimization/Results/Equal mean test/optimal solution equal mean test alpha ",
  ...
  ggsave(paste0("Cocaine Network Optimization/Results/Equal mean test/optimal networks equal mean test alpha ",
                period[1], "-", period[length(period)],
                " (alpha=",
                alpha,
                ", z=",
